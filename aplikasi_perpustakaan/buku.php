...
if (isset($_POST['anggota'])) {
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO
        perpus (nama, email, hp,) 
        VALUES('$nama','$email','$hp')");
    if ($insert) {
        // redirect
        header("location:anggota.php?success=anggota");
    }
}
...
<head>
    ...
    <title>Angoota Perpustakaan - PPKD Jakarta Pusat</title>
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <?php if (isset($_GET['success']) == 'anggota') : ?>
                                    ...
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Anggota Perpustakaan - PPKD Jakarta Pusat</h1>
                                        <!-- </div>
                                    <form class="user" method="post">
                                        ...
                                        <div class="form-group">
                                            <input name="nama" type="text" class="form-control form-control-user"
                                                aria-describedby="emailHelp" placeholder="Masukkan Nama Buku ">
                                        </div>


                                        <div class="form-group">
                                            <input name="penerbit" type="text" class="form-control form-control-user"
                                                aria-describedby="emailHelp" placeholder="Masukkan Nama penerbit ">
                                        </div>

                                        <div class="form-group">
                                            <input name="qty" type="text" class="form-control form-control-user"
                                                aria-describedby="emailHelp" placeholder="banyaknya quantity ">
                                        </div>

                                        <div class="form-group">
                                            <input name="genre" type="text" class="form-control form-control-user"
                                                aria-describedby="emailHelp" placeholder="Masukkan jenis genre">
                                        </div>

                                        <div class="form-group">
                                            <input name="penulis" type="text" class="form-control form-control-user"
                                                aria-describedby="emailHelp" placeholder="Masukkan Nama Penulis ">
                                        </div>


                                        <div class="form-group">
                                            <input name="deskripsi" type="email" class="form-control form-control-user"
                                        ...
                                        <button name="login" type="submit" class="btn btn-primary btn-user btn-block">
                                            Login Daftar Anggota
                                        </button>
                                        </form>
                                        <!--</div>
                                        <div class="form-group">
                                            <input name="gender" type="radio" id="exampleInputPassword"
                                    ...
                                    <div class="form-group">
                                        <input type="text" readonly
                                            value="<?php echo $dataGelombang['nama_gelombang'] ?>" class="form-control"
                                            placeholder="Nama Gelombang">
                                        <input type="hidden" name="id_gelombang"
                                            value="<?php echo $dataGelombang['id'] ?>">
                                    </div>
